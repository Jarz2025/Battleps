document.addEventListener("DOMContentLoaded", function () {
    ...
    container.innerHTML = `
      <div class="app-instructions show fade-in bg-[#1a1a1a] rounded p-5 space-y-4 border border-gray-700">
        ...
        <p class="text-xs text-red-400 italic mt-4">
          NOTE: If you experience problems when logging in, please open a ticket on our Whatsapp.
        </p>
      </div>
    `;
  }
  ...
  function getFeatureDesc(feature, config) {
    ...
    const descs = {
      ...
      'Find': 'All Of Item Is Free!.',
      'Spotify': 'Yes!. You can play a song when playing the private server!.',
